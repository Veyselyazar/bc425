class ZCL_EX_BC42_01_BADI definition
  public
  final
  create public .
...
public section.
  ...
  interfaces ZIF_EX_BC42_01_BADI .
...
CLASS ZCL_EX_BC42_01_BADI IMPLEMENTATION.


  method ZIF_EX_BC42_01_BADI~WRITE_ADDITIONAL_COLS.
  CLASS CL_EXIT_MASTER DEFINITION LOAD.
  DATA: EXIT_OBJ_TAB TYPE SXRT_EXIT_TAB.

  DATA: exitintf TYPE REF TO ZIF_EX_BC42_01_BADI,
  ...
  IF sy-subrc NE 0.
    ...
    <flt_cache_line>-method_name = 'WRITE_ADDITIONAL_COLS'.
        ...
        CALL METHOD CL_EXIT_MASTER=>CREATE_OBJ_BY_INTERFACE_FILTER
           EXPORTING
              CALLER       = me
              INTER_NAME   = 'ZIF_EX_BC42_01_BADI'
              METHOD_NAME  = 'WRITE_ADDITIONAL_COLS'
  ...
  IF <flt_cache_line>-valid = sxrt_true.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = '051M12S}7jogqQLkpOv2Vm'
           TYP     = 'UE'.
        ...
        IF <flt_cache_line>-eo_object is initial.
          CALL METHOD ('CL_FOBU_METHOD_EVALUATION')=>load
               EXPORTING
                  ...
                  im_interface_name = 'ZIF_EX_BC42_01_BADI'
